...
Next.js 16 frontend and API backend for the x402 Payment Marketplace. Enables developers to list APIs and monetize them with USDC payments on Base Sepolia using the x402 payment protocol.
